...
export default function ProfilePage() {
  ...
  const overallPercent = Math.round(totalScore / (skills.length * 100) * 100);
        ...
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 28 }}>
              <div style={{
                ...
                background: `linear-gradient(135deg, ${T.blue}, ${T.green})`,
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: 28, fontWeight: 900, color: "#050e1e",
                boxShadow: T.glowBlue, flexShrink: 0,
              }}>{initial}</div>
              <div>
                ...
                <div style={{
                  ...
                  borderRadius: 20, background: "rgba(56,189,248,0.1)",
                  border: `1px solid rgba(56,189,248,0.25)`,
                  fontSize: 11, color: T.blue, fontWeight: 600,
                }}>B1 · Intermediate</div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                <div style={{
                  padding: "11px 14px", borderRadius: 10, fontSize: 14, color: T.white,
              ...
              <div>
                ...
                <div style={{
                  padding: "11px 14px", borderRadius: 10, fontSize: 14, color: T.muted,
                  background: T.surface2, border: `1px solid ${T.border}`,
                }}>{email}</div>
              </div>
                ...
                {editing ? (
                  <input
                    ...
                    style={{
                      ...
                      fontSize: 14, color: T.white, background: T.surface2,
                      border: `1px solid ${T.blue}`, outline: "none",
                  ...
                  <div style={{
                    ...
                    color: phone ? T.white : T.muted,
                    background: T.surface2, border: `1px solid ${T.border}`,
                  }}>{phone || "ยังไม่ได้กรอก"}</div>
                )}
              </div>
              ...
              <div>
                ...
                {editing ? (
                  <textarea
                    ...
                    placeholder="เช่น 123 ถ.สุขุมวิท กรุงเทพฯ 10110"
                    rows={3}
                    style={{
                      width: "100%", padding: "11px 14px", borderRadius: 10,
                      fontSize: 14, color: T.white, background: T.surface2,
                  ...
                  <div style={{
                    padding: "11px 14px", borderRadius: 10, fontSize: 14,
                    color: address ? T.white : T.muted,
                    background: T.surface2, border: `1px solid ${T.border}`,
                    minHeight: 60,
                  }}>{address || "ยังไม่ได้กรอก"}</div>
                )}
              </div>
                ...
                {editing ? (
                  <>
                    <button onClick={handleSave} style={{
                      ...
                      background: `linear-gradient(135deg, ${T.blue}, ${T.green})`,
                      color: "#050e1e", fontSize: 14, fontWeight: 700, cursor: "pointer",
                    }}>บันทึก</button>
                  ...
                  <button onClick={() => setEditing(true)} style={{
                    flex: 1, padding: "11px 0", borderRadius: 10, border: `1px solid ${T.borderHi}`,
                    background: "transparent", color: T.blue, fontSize: 14, fontWeight: 600, cursor: "pointer",
                  }}>✏️ แก้ไขข้อมูล</button>
                )}
              </div>
              {saved && (
                <div style={{ textAlign: "center", fontSize: 13, color: T.green }}>✅ บันทึกเรียบร้อยแล้ว</div>
              )}
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              padding: "16px", background: T.surface2, borderRadius: 12,
            }}>
              <div style={{
                width: 64, height: 64, borderRadius: "50%", flexShrink: 0,
                background: `conic-gradient(${T.blue} ${overallPercent * 3.6}deg, ${T.border} 0deg)`,
                display: "flex", alignItems: "center", justifyContent: "center",
                position: "relative",
              }}>
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 14, fontWeight: 900, color: T.blue,
                }}>{overallPercent}%</div>
              </div>
              <div>
                ...
                <div key={s.label}>
                  ...
                  <div style={{ height: 6, borderRadius: 99, background: T.border }}>
                    <div style={{
                      ...
                      background: s.col, transition: "width 0.5s ease",
                    }} />
                  </div>
                </div>
              ))}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginTop: 20 }}>
              {[
                { label: "บทเรียนที่เรียน", value: "0", unit: "บท" },
                { label: "XP สะสม",        value: "0", unit: "XP" },
                { label: "วันที่เรียน",     value: "0", unit: "วัน" },
              ].map((stat) => (
                <div key={stat.label} style={{
                  background: T.surface2, borderRadius: 12, padding: "14px",
